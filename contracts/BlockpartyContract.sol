...
contract BlockpartyContract is ERC165, ERC721URIStorage, EIP712, AccessControl, Ownable {
    ...
    struct Voucher {
        ...
        /// @notice The deadline determines the deadline
    ...
    function _hash(Voucher calldata voucher) internal view returns (bytes32) {
        return _hashTypedDataV4(keccak256(abi.encode(
            keccak256("Voucher(string key,uint256 price,address from,address to,string uri,bool giveaway,uint256 deadline)"),
